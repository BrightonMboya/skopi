      ...
      <div className="relative pt-6 pb-16 sm:pb-24">
        ...
        <main className="mx-auto mt-16 max-w-7xl px-4 sm:mt-24">
          <div className="text-left">
            <h1 className="text-5xl font-medium text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block xl:inline">Reduce Fashion Waste</span>{" "}
              <span className="block text-indigo-600 xl:inline text-6xl">
                Recycling.
              </span>
            </h1>
            <p className="mx-auto mt-[2rem] max-w-md text-lg  text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl">
              Here at Skope, we believe that a good design shouldn’t produce
              waste.
            </p>
            <div className="mx-auto mt-[2rem] max-w-md sm:flex sm:justify-center md:mt-8">
